...
export default async function DataPage({
  ...
  return (
    <div className="app-shell">
      <AppSidebar active="data" />
      <main className="main">
        <div className="panel-header">
          <div>
            <h1>Data Hub</h1>
            <p>Public dataset catalog — sign in for advanced access and downloads.</p>
          </div>
        </div>
        ...
        <div className="info-banner" style={{ marginTop: '20px' }}>
          Sign in and request the appropriate role to download gated datasets.
        </div>
      </main>
    </div>
  );
