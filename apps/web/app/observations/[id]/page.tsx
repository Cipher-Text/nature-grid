    ...
    <div className="app-shell">
      ...
      <main className="main">
        ...
        <div className="access-note">
          <strong>Contribute your own observations</strong>
          <span>
            <Link href="/register">Create a free account</Link> or{' '}
            <Link href="/login">sign in</Link> to submit environmental observations
            that help build Bangladesh&apos;s open nature data record.
          </span>
        </div>
      </main>
    </div>
