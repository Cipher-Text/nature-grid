...
| Prisma schema | Done | 19 enums, 30 models — includes dedicated `OrganizationType`, `OrganizationMemberRole`, and `OrganizationMembership`; client regenerated |
| Database migration — M4 | Done | 17 migrations applied, 30 tables live (latest: `20260825140000_add_organization_memberships`); Postgres on port 5433 (remapped — local Postgres occupies 5432) |
